...
\newcommand\transportInterface[1]{
  \begin{figure}[t]
    ...
    \begin{minipage}{0.8\linewidth}
      \toplisting
      \input{../transport/transport/core/shared/src/main/scala/transport/Transport.listings}
      \lstset{caption=#1,label=transportInterface}
      \input{../transport/transport/core/shared/src/main/scala/transport/package.listings}
      \bottomlisting
    \end{minipage}
  \end{figure}
}
...
\newcommand\engineInterface[1]{
  \customlisting{t}{engineInterface}{0.75}{#1}
    {lag-comp/lag-comp/src/main/scala/AbstractEngine.listings}
}
